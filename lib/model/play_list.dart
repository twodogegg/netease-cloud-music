...
class Al {
  ...
  Al({num id, String name, String picUrl, num pic, bool canPlay, String mp3Url}) {
    this._id = id;
    this._name = name;
    this._picUrl = picUrl;
    this._pic = pic;
   ...
   num get id => _id;
    ...
    set picUrl(String value) => _picUrl = value;
    num get pic => _pic;
    set pic(num value) => _pic = value;
    bool get canPlay => _canPlay;
    set canPlay(bool value) => _canPlay = value;
    String get mp3Url => _mp3Url;
    set mp3Url(String value) => _mp3Url = value;
